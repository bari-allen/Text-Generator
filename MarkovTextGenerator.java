...
/**
 * A class designed to generate text using a Markov model. It reads an input text file,
 * builds a Markov model based on the text, and generates new text that mimics the style
 * and structure of the input. This class is the driver for the application
 */
...
public class MarkovTextGenerator {
	...
	public static void main(String[] args) {
		...
		String filePath = "pride-and-prejudice.txt"; // CHANGE ME
	 ...
	 * This method uses a BufferedReader to read the file line by line, appending each line
	 * (and a newline character) to a StringBuilder to construct the entire file content.
	 *
